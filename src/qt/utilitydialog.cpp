    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("PEPEPOW Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About PEPEPOW Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  PEPEPOW-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the PEPEPOW in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PEPEW, 0.1 PEPEW, 1 PEPEW and 10 PEPEW -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("PEPEPOW Core is shutting down...") + "<br /><br />" +
