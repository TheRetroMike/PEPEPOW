    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("PEPEPOW Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PEPEPOW address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PEPEPOW: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About PEPEPOW Core"), this);
    aboutAction->setStatusTip(tr("Show information about PEPEPOW Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PEPEPOW Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PEPEPOW addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PEPEPOW addresses"));
    ...
    openAction->setStatusTip(tr("Open a PEPEPOW: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PEPEPOW Core help message to get a list with possible PEPEPOW Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PEPEPOW Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PEPEPOW network", "", count));
    } else {
...
{
    QString strTitle = tr("PEPEPOW Core"); // default title
